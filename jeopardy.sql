...
(7, 'Matematicas', 'Aritmetica', 'Cuantos digitos tiene 2 a la 1998 multiplicado por 5 a la 2000', '2000', 500),
...
(19, 'Geografia', 'Montanas', 'Cual es la cordillera mas larga', 'Andes', 200),
(20, 'Geografia', 'Montanas', 'Por cuantos paises pasan los alpes', '8', 300),
(21, 'Geografia', 'Montanas', 'Cual fue el volcan que destruyo Pompeii en el ano 79 AD', 'Monte Vesubio', 400),
...
(26, 'Geografia', 'Rios', 'En que pais esta el rio Lena', 'Rusia', 400),
...
(30, 'Geografia', 'Lagos', 'Pais donde residiria el monstruo del Lago Ness, de existir', 'Escocia', 300),
...
(34, 'Fisica', 'Electricidad y Magnetismo', 'Capacidad que tiene un campo electrico de realizar trabajo', 'Potencial electrico', 400),
...
(37, 'Fisica', 'Cinematica', 'La velocidad de rotacion es tambien conocida como la velocidad..', 'Angular', 200),
...
(39, 'Fisica', 'Cinematica', 'Fuerza ficticia que aparece cuando se describe el movimiento de un cuerpo en un sistema de referencia en rotacion', 'Fuerza centrigufa', 400),
(40, 'Fisica', 'Cinematica', 'Medida de la variacion maxima del desplazamiento de un movimiento ooscilatorio', 'amplitud', 500),
...
(43, 'Historia', 'Guerras', 'Duracion en anos de la guerra de los 100 anos', '116', 300),
(44, 'Historia', 'Guerras', 'Quien dirigia las tropas britanicas en contra de Napoleon en la batalla de Waterloo', 'Duque de Wellington', 400),
(45, 'Historia', 'Guerras', 'Ano en que se llevo a cabo la batalla de Lyngor', '1812', 500),
(46, 'Historia', 'Presidentes de Mexico', 'Presidente de mexico para el periodo 2000-2006', 'Vicente Fox', 100),
(47, 'Historia', 'Presidentes de Mexico', 'Primer presidente de Mexico', 'Guadalupe Victoria', 200),
(48, 'Historia', 'Presidentes de Mexico', 'Presidente de mexico para el periodo 1982-1988', 'Miguel de la Madrid', 300),
(49, 'Historia', 'Presidentes de Mexico', 'Cuantos presidentes diferentes ha tenido Mexico', '62', 400),
(50, 'Historia', 'Presidentes de Mexico', 'Ano en que fue presidente Felix Maria Zuloaga', '1858', 500),
...
(58, 'Quimica', 'Compuestos', 'Compuestos formados por un metal y oxigeno', 'Oxidos Basicos', 300),
...
(66, 'Biologia', 'Celulas', 'Organulos celulares que en los organismos eucariontes fotosintetizadores se ocupan de la fotosintesis', 'Cloroplastos', 100),
(67, 'Biologia', 'Celulas', 'Bicapa lipidica que delimita todas las celulas', 'Membrana plasmatica', 200),
